...
local Library = {
    ...
    MainColor = Color3.fromRGB(28, 29, 35);
    BackgroundColor = Color3.fromRGB(15, 15, 15);
    AccentColor = Color3.fromRGB(255, 255, 255);
    OutlineColor = Color3.fromRGB(33, 36, 44);
...
function Library:MakeDraggable(Instance, Cutoff, UseDragOutline)
    ...
    local function ShowDragGhost()
        if not UseDragOutline then
            return;
        end;
    ...
    Library:GiveSignal(InputService.InputChanged:Connect(function(Input)
        ...
        local NewPosition = GetDragPosition(Input);
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        ColorPicker.Instance = DisplayFrame
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:Update()
            ...
            ContainerLabel.Text = string.format('[%s] %s (%s)', tostring(KeyPicker.Value or 'None'), tostring(Info.Text or ''), tostring(KeyPicker.Mode or 'Toggle'));
        ...
        function KeyPicker:GetState()
            ...
            elseif KeyPicker.Mode == 'Hold' then
                ...
                if Key == 'MB1' or Key == 'MB2' then
                    ...
                    local KeyName = tostring(KeyPicker.Value or ''):gsub('Enum.KeyCode.', ''):gsub('Enum.UserInputType.', '')
                    local KeyCode
        ...
        function KeyPicker:SetValue(Data)
            ...
            Key = tostring(Key or 'None'):gsub('Enum.KeyCode.', ''):gsub('Enum.UserInputType.', '')
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            if (not Picking) then
                ...
                elseif KeyPicker.Mode == 'Hold' then
                    ...
                    elseif Input.UserInputType == Enum.UserInputType.Keyboard then
                        if Input.KeyCode.Name == Key and not KeyPicker.Toggled then
                            KeyPicker.Toggled = true;
                            KeyPicker:DoClick();
                        end;
                    end;
        ...
        Library:GiveSignal(InputService.InputEnded:Connect(function(Input)
            if (not Picking) then
                if KeyPicker.Mode == 'Hold' then
                    ...
                    elseif Input.UserInputType == Enum.UserInputType.Keyboard then
                        if Input.KeyCode.Name == Key and KeyPicker.Toggled then
                            KeyPicker.Toggled = false;
                            KeyPicker:DoClick();
                        end;
                    end;
...
do
        ...
        local function InitEvents(Button)
            ...
            Button.Outer.InputBegan:Connect(function(Input)
                ...
                if Button.DoubleClick then
                    ...
                    local clicked = WaitForEvent(Button.Outer.InputBegan, 1.0, ValidateClick)
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        Toggle.Stroke = Library:Create('UIStroke', {
        ...
        Library:AddToRegistry(Toggle.Stroke, {
            Color = 'OutlineColor';
        });
        ...
        function Toggle:Display()
            ...
            if Toggle.Stroke then
                Toggle.Stroke.Enabled = Toggle.Value;
                Toggle.Stroke.Color = Library.OutlineColor;
            end;
        end;
        ...
        Toggle:Display();
        Toggle.BlankInstance = Groupbox:AddBlank(Info.BlankSize or 5 + 2);
        Groupbox:Resize();
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local Container = Groupbox.Container;
        local SliderLabel;
        local SliderLabelGap;
        local SliderBottomBlank;
        ...
        if not Info.Compact then
            ...
            SliderLabelGap = Groupbox:AddBlank(3);
        end
        ...
        Slider:Display();
        SliderBottomBlank = Groupbox:AddBlank(Info.BlankSize or 6);
        Groupbox:Resize();
    ...
    function Funcs:AddDependencyBox()
        ...
        function Depbox:SetupDependencies(Dependencies)
            for _, Dependency in next, Dependencies do
                assert(type(Dependency) == 'table', 'SetupDependencies: Dependency is not of type 	able`.');
...
function Library:SetWatermark(Text)
    ...
    if Library.WatermarkVisible ~= nil then
        Library.Watermark.Visible = Library.WatermarkVisible;
    end;
end;
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(550, 675) end
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddGroupbox(Info)
            ...
            local GroupboxLabel = Library:CreateLabel({
                ...
                TextSize = 14;
                Text = string.lower(tostring(Info.Name));
                TextXAlignment = Enum.TextXAlignment.Left;
                ZIndex = 5;
                Parent = BoxInner;
            });
    ...
    local function VantageNormalizeOuterAnchor()
        ...
        local ParentAbs = Vector2.zero;
        if Outer.Parent and Outer.Parent:IsA('GuiObject') then
            ParentAbs = Outer.Parent.AbsolutePosition;
        end;
    ...
    VantageNativeResizeGrip.InputBegan:Connect(function(Input)
        ...
        while Dragging and ScreenGui.Parent do
            local Delta = InputService:GetMouseLocation() - StartMouse;
            local NewX = math.clamp(StartSize.X + Delta.X, 585, 1200);
            local NewY = math.clamp(StartSize.Y + Delta.Y, 710, 900);
            Outer.Size = UDim2.fromOffset(math.floor(NewX + 0.5), math.floor(NewY + 0.5));
            RenderStepped:Wait();
        end;
    end);
